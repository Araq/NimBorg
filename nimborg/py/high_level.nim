...
# short-term TODO:
#
# * export nim values (especially functions) to python (with new python type objects).
# *
#
# mid-range TODO:
#
# * don't print exceptions, retrieve the exception information into nim
#
...
#-------------------------------------------------------------------------------
# conversion of nim values to/from python values
